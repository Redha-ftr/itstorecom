		    ...
		    <div class="col-md-6">
		      <div class="content-box">
		        ...
		        <div class="form-group">
				  ...
				  <input class="form-control" name="nama" placeholder="<?=$this->lang->line('placeholder_kategori')?>" type="text">
...
<script type="text/javascript">
	...
	function validate(formData) {
		...
		$.ajax({
			url: "<?php echo base_url() . 'category/validate'; ?>", async: false, type: 'POST', data: formData,
	...
	function save(formData) {
		...
		$.post("<?php echo base_url() . 'category/action'; ?>", formData).done(function(data) {

		    ...
		    <div class="col-md-6">
		      <div class="content-box">
		        ...
		        <div class="form-group">
				  <label for=""> <?=$this->lang->line('title_social_media')?></label>
				  <input class="form-control" name="nama" placeholder="<?=$this->lang->line('placeholder_social_media')?>" type="text">
...
<script type="text/javascript">
	...
	function validate(formData) {
		...
		$.ajax({
			url: "<?php echo base_url() . 'social_media/validate'; ?>", async: false, type: 'POST', data: formData,
	...
	function save(formData) {
		...
		$.post("<?php echo base_url() . 'social_media/action'; ?>", formData).done(function(data) {

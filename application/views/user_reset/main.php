						...
						<div class="content-box-header">
							<div class="row">
								<div class="col-md-12 form-inline justify-content-end">
									<select class="form-control col-md-2 mb-1 mr-sm-1 mb-sm-0" id="search-option"></select>
									<input class="form-control col-md-4" id="search" placeholder="Search" type="text">
								</div>
							</div>
						</div>
...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		url						: "<?php echo base_url() . 'user_reset/data'; ?>",
		primaryField			: 'id', 
		rowNumber				: true,
		...
		columns					: [
		{field: 'name', title: 'Full Name', editable: true, sortable: false, width: 200, align: 'center', search: true},
		{field: 'username', title: 'Username', editable: true, sortable: false, width: 300, align: 'center', search: true},
		{field: 'group_name', title: 'Group Name', editable: true, sortable: false, width: 200, align: 'center', search: true},
	...
	function create_update_form(rowIndex) {
		$.post("<?php echo base_url() . 'user_reset/form'; ?>", {index : rowIndex}).done(function(data) {
	...
	function delete_action(rowIndex) {
		swal({   
			...
			$.post("<?php echo base_url() . 'user_reset/delete'; ?>", {id : row.id}).done(function(data) {
				$('.loading-panel').hide();
				$('.form-panel').hide();
